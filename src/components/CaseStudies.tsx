...
import { ArrowRight, Play, X, ExternalLink, Maximize2 } from "lucide-react";
...
export function CaseStudies() {
  ...
  const filteredWorks = works.filter((w) => {
    ...
    if (selectedCat === "video") return type === "video" || cat.includes("video") || cat.includes("broadcast") || cat.includes("stream");
    if (selectedCat === "design") return cat.includes("design") || cat.includes("desain") || cat.includes("grafis");
    if (selectedCat === "photo") return cat.includes("photo") || cat.includes("foto");
    if (selectedCat === "social") return cat.includes("social") || cat.includes("sosial") || cat.includes("media");
    return true;
  });
            ...
            >
                ...
                <div className="flex items-center gap-2 shrink-0">
                  ...
                  {activeMedia.directUrl && (
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="hidden sm:inline-flex items-center gap-1.5 rounded-full border border-glass-300 bg-white/80 dark:bg-slate-900/80 px-3 py-1.5 font-display text-xs font-semibold text-text-primary transition-all hover:border-accent-400 hover:text-accent-500"
                    >
              ...
              <div className="relative bg-black">
                ...
                {activeMedia.platform === "tiktok" && (
                  <div className="flex flex-col items-center justify-center p-3 sm:p-4 bg-slate-950">
                    {activeMedia.embedUrl ? (
                      <div className="relative w-full max-w-[340px] aspect-[9/16] max-h-[68vh] overflow-hidden rounded-2xl bg-black shadow-2xl">
                        <iframe
                          src={activeMedia.embedUrl}
                          title={activeWork.title}
                ...
                {activeMedia.platform === "instagram" && (
                  <div className="flex flex-col items-center justify-center p-3 sm:p-4 bg-slate-950">
                    {activeMedia.embedUrl ? (
                      <div className="relative w-full max-w-[420px] min-h-[460px] max-h-[70vh] overflow-hidden rounded-2xl bg-white shadow-2xl">
                        <iframe
                          src={activeMedia.embedUrl}
                          title={activeWork.title}
                ...
                {(activeMedia.platform === "image" ||
                  ...
                  <div className="max-h-[75vh] w-full flex items-center justify-center bg-slate-950 p-2">
              ...
              {/* Footer Bar */}
              <div className="flex flex-wrap items-center justify-between gap-3 border-t border-glass-300/50 bg-glass-50 px-5 py-3.5">
                ...
                {activeMedia.directUrl && (
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="inline-flex sm:hidden items-center gap-1.5 rounded-full bg-accent-500 px-4 py-1.5 font-display text-xs font-semibold text-white shadow-md"
                  >
                    <PlatformMediaIcon platform={activeMedia.platform} size={13} />
                    {t.openLink}
                    <ExternalLink size={11} />
